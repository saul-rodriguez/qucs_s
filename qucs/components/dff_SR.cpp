...
void dff_SR::createSymbol()
{
  ...
  Lines.append(new Line(-50, 20,-30, 20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 30, 20, 50, 20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 30,-20, 50,-20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line( -30, 10,-20, 20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -30, 30,-20, 20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line(  0, -50,  0, -60,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0,  50,  0,  60,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Arcs.append(new Arc( -5,-50, 10, 10, 0, 16*360, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Arcs.append(new Arc( -5, 40, 10, 10, 0, 16*360, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
