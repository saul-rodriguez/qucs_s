...
{
  Lines.append(new Line(-40, -90, 40,-90,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 40, -90, 40,100,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 40, 100,-40,100,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-40, 100,-40,-90,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line(-60,-50,-40,-50,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // X0
  Lines.append(new Line(-60,-30,-40,-30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // X1
  Lines.append(new Line(-60,-10,-40,-10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // X2
  Lines.append(new Line(-60, 10,-40, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // X3
  Lines.append(new Line(-60, 30,-40, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y0
  Lines.append(new Line(-60, 50,-40, 50,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y1
  Lines.append(new Line(-60, 70,-40, 70,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y2
  Lines.append(new Line(-60, 90,-40, 90,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y3
  Lines.append(new Line( 40, 30, 60, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // L
  Lines.append(new Line( 40, 10, 60, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // G
  Lines.append(new Line( 40,-10, 60,-10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // E
