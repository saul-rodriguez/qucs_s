...
void mux4to1::createSymbol()
{
  ...
  Lines.append(new Line( 30, -80, 30, 100,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 30,  100,-30, 100,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-30, 100,-30, -80,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line(-50,-40,-40,-40,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-50,-20,-30, -20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-50, 0, -30, 0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-50, 30, -30, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-50, 50,-30, 50,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-50, 70, -30, 70,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-50, 90, -30, 90,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line( 30, 10, 50, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  ...
  Lines.append(new Line(11, -8, 23, -8, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
