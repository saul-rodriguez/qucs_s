...
Equation::Equation()
{
  ...
  Lines.append(new Line(-xb, -yb, -xb,  yb,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-xb,  yb,  xb+3,yb,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
