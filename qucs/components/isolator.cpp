...
Isolator::Isolator()
{
  ...
  Lines.append(new Line( -8,  0,  8,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  8,  0,  0, -5,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  8,  0,  0,  5,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
