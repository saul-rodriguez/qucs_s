...
Volt_noise::Volt_noise()
{
  ...
  Lines.append(new Line(-10,  6,  6,-10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -7, 10, 10, -7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -2, 12, 12, -2,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
