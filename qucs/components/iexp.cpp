...
iExp::iExp()
{
  ...
  Lines.append(new Line( 30,  0, 12,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -7,  0,  7,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  6,  0,  0, -4,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  6,  0,  0,  4,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  // write 'Exp' beside current source symbol
  Lines.append(new Line( 13,  7, 13, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 13,  7, 21, 7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 17,  7, 17, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 21,  7, 21, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 13,  13, 17, 17,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 17,  13, 13, 17,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 17,  20, 11, 20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 17,  20, 17, 23,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 13,  20, 13, 23,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 17,  23, 13, 23,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
