...
vExp::vExp()
{
  ...
  Lines.append(new Line( -3,  -7, -3, -4,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -3,  -7, 5, -7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 1,  -7, 1, -4,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 5,  -7, 5, -4,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -3,  -1, 1, 3,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 1,  -1, -3, 3,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 1,  6, -5, 6,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 1,  6, 1, 9,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -3,  6, -3, 9,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 1,  9, -3, 9,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
