...
RLCG::RLCG()
{
  ...
  Lines.append(new Line(-28,  7, 28,  7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line(-28, 14,-21,  7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-21, 14,-14,  7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-14, 14, -7,  7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -7, 14,  0,  7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0, 14,  7,  7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  7, 14, 14,  7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 14, 14, 21,  7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 21, 14, 28,  7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
