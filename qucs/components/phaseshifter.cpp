...
Phaseshifter::Phaseshifter()
{
  ...
  Lines.append(new Line(-14,-14, 14,-14,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-14, 14, 14, 14,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-14,-14,-14, 14,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 14,-14, 14, 14,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Arcs.append(new Arc( -9, -9, 17, 17, 0, 16*360,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-10, 10, 10,-10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line(-30,  0,-14,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 14,  0, 30,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
