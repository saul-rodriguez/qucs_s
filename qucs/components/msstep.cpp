...
MSstep::MSstep()
{
  ...
  Lines.append(new Line(-18,-12,  0,-12,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-18, 12,  0, 12,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-18,-12,-18, 12,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0, -7, 18, -7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0,  7, 18,  7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 18, -7, 18,  7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0,-12,  0, -7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0,  7,  0, 12,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
