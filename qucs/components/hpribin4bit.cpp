...
void hpribin4bit::createSymbol()
{
  ...
  Lines.append(new Line(-60,-10,-40,-10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // A
  Lines.append(new Line(-60, 10,-40, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // B
  Lines.append(new Line(-60, 30,-40, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // C
  Lines.append(new Line(-60, 50,-40, 50,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // D
  Lines.append(new Line( 40, 30, 60, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // V
  Lines.append(new Line( 40, 10, 60, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y
  Lines.append(new Line( 40,-10, 60,-10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // X
