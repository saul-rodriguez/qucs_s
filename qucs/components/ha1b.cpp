...
void ha1b::createSymbol()
{
  ...
  Lines.append(new Line( 30, -40, 30, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 30,  30,-30, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-30,  30,-30,-40,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
