...
MSgap::MSgap()
{
  ...
  Lines.append(new Line( 10, -8, 23, -8,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-23,  8,-10,  8,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0,  8, 13,  8,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  ...
  Lines.append(new Line( 10, -8,  0,  8,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
