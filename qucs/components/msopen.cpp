...
MSopen::MSopen()
{
  ...
  Lines.append(new Line(-13, -8, 13, -8,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-23,  8,  3,  8,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
