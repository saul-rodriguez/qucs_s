...
CoaxialLine::CoaxialLine()
{
  ...
  Lines.append(new Line(-30,  0,-16,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 19,  0, 30,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
