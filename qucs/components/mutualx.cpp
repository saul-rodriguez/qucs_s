...
void MutualX::createSymbol()
{
  ...
  x -= 6;
  for(int i=0; i<Num; i++) {
    Arcs.append(new Arc(x,-18,12,12, 16*270,16*180, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    Arcs.append(new Arc(x, -6,12,12, 16*270,16*180, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    Arcs.append(new Arc(x,  6,12,12, 16*270,16*180, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

    x += 6;
    Lines.append(new Line(x,-18,x,-30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    Lines.append(new Line(x, 18,x, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
