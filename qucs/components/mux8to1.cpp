...
{
  Lines.append(new Line(-30, -80, 30,-80,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 30, -80, 30, 190,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 30, 190,-30, 190,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-30, 190,-30, -80,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line(-50,-40,-40,-40,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  //EN
  Lines.append(new Line(-50,-20,-30, -20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness))); //A
  Lines.append(new Line(-50, 0, -30, 0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));   //B
  Lines.append(new Line(-50, 20, -30, 20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness))); //C

  Lines.append(new Line(-50, 40, -30, 40,QPen(gCustomPref.componentColor,gCustomPref.componentThickness))); //D0
  Lines.append(new Line(-50, 60, -30, 60,QPen(gCustomPref.componentColor,gCustomPref.componentThickness))); //D1
  Lines.append(new Line(-50, 80, -30, 80,QPen(gCustomPref.componentColor,gCustomPref.componentThickness))); //D2
  Lines.append(new Line(-50, 100,-30,100,QPen(gCustomPref.componentColor,gCustomPref.componentThickness))); //D3
  Lines.append(new Line(-50, 120,-30,120,QPen(gCustomPref.componentColor,gCustomPref.componentThickness))); //D4
  Lines.append(new Line(-50, 140,-30,140,QPen(gCustomPref.componentColor,gCustomPref.componentThickness))); //D5
  Lines.append(new Line(-50, 160,-30,160,QPen(gCustomPref.componentColor,gCustomPref.componentThickness))); //D6
  Lines.append(new Line(-50, 180,-30,180,QPen(gCustomPref.componentColor,gCustomPref.componentThickness))); //D7
  Lines.append(new Line( 30, 60, 50, 60,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y

  Arcs.append(new Arc( -40, -45, 10, 10, 0, 16*360, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  ...
  Lines.append(new Line(11, 0, 23, 0, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
