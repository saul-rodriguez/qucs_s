...
void Logical_Inv::createSymbol()
{
  ...
  if(Props.getLast()->Value.at(0) == 'D') {  // DIN symbol
    Lines.append(new Line( 15,-20, 15, 20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    Lines.append(new Line(-15,-20, 15,-20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    Lines.append(new Line(-15, 20, 15, 20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    Lines.append(new Line(-15,-20,-15, 20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    ...
    Lines.append(new Line(-10,-20,-10,20, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    Arcs.append(new Arc(-30,-20, 40, 30,  0, 16*90,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    Arcs.append(new Arc(-30,-10, 40, 30,  0,-16*90,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    Lines.append(new Line( 10,-5, 10, 5,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    xr =  10;
  }
  ...
  Lines.append(new Line( xr, 0, 30, 0, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-30, 0,-xr, 0, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
