...
void dmux3to8::createSymbol()
{
  ...
  Lines.append(new Line( 30, -90, 30, 100,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 30,  100,-30, 100,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-30,  100,-30, -90,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  ...
  Lines.append(new Line( 30, 90, 50, 90,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y7
  Lines.append(new Line( 30, 70, 50, 70,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y6
  Lines.append(new Line( 30, 50, 50, 50,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y5
  Lines.append(new Line( 30, 30, 50, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y4
  ...
  Lines.append(new Line(0, -11, 12, -11, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
