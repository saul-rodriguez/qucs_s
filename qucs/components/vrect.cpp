...
vRect::vRect()
{
  ...
  Lines.append(new Line( -5, -7, -5, -5,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -5, -5,  5, -5,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  5, -5,  6,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -5,  0,  6,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -5,  0, -5,  5,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -5,  5,  5,  5,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  5,  5,  5,  7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
