...
MSrstub::MSrstub()
{
  ...
  Arcs.append(new Arc( -26, -26, 52, 52,16*45, 16*90,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line(-5,   0,  5,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-5,   0,-18,-18,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 5,   0, 18,-18,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 0,   0,  0, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
