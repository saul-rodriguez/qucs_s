...
Ampere_noise::Ampere_noise()
{
  ...
  Lines.append(new Line(-12,  1,  1,-12,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-10,  6, -7,  3,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  3, -7,  6,-10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -7, 10, -2,  5,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  7, -4, 10, -7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -1, 12, 12, -1,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
