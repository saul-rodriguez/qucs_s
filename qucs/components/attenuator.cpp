...
Attenuator::Attenuator()
{
  ...
  Lines.append(new Line(  4, -6,  4,  6,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -4,  6,  4,  6,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0,-11,  0, -6,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0,  6,  0, 11,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
