...
CCVS::CCVS()
{
  ...
  Lines.append(new Line(-12, 20,-17, 11,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-12, 20, -8, 11,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
