...
iRect::iRect()
{
  ...
  Lines.append(new Line( 19,  5, 19,  7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 13,  7, 19,  7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 13,  7, 13, 11,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 13, 11, 19, 11,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 19, 11, 19, 15,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 13, 15, 19, 15,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 13, 15, 13, 17,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
