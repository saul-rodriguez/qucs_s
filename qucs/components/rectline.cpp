...
RectLine::RectLine()
{
  ...
  Lines.append(new Line(-30,  0,-17,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 18,  0, 30,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line(-14, -7, 18, -7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-14, -7,-14, 11,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-14, 11, 18, 11,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 18, -7, 18, 11,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-20,-13, 12,-13,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-20,-13,-20,  5,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line(-20,-13,-14, -7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 12,-13, 18, -7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-20,  5,-14, 11,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
