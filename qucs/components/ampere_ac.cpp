...
Ampere_ac::Ampere_ac()
{
  ...
  Lines.append(new Line(  6,  0,  0,  4,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Arcs.append(new Arc( 12,  5,  6,  6,16*270, 16*180,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Arcs.append(new Arc( 12, 11,  6,  6, 16*90, 16*180,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
