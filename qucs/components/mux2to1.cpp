...
void mux2to1::createSymbol()
{
  ...
  Lines.append(new Line( 30, -60, 30, 50,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 30,  50,-30, 50,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-30,  50,-30,-60,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line(-50,-20,-40,-20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  ...
  Lines.append(new Line(-50, 40,-30, 40,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line( 30, 0, 50, 0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Arcs.append(new Arc(-40, -25, 10, 10, 0, 16*360, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
