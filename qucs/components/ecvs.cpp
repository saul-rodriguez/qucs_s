...
//  Arcs.append(new Arc( -3, -7,  7,  7,16*270, 16*180,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
//  Arcs.append(new Arc( -3,  0,  7,  7, 16*90, 16*180,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
...
//  Lines.append(new Line( -3,-15, -3,-23,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
//  Lines.append(new Line(-13,-15,-13,-23,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
//  Lines.append(new Line( -3,-23,-13,-23,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
//  Lines.append(new Line( -3,-15,-13,-15,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
