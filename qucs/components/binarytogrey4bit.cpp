...
void binarytogrey4bit::createSymbol()
{
  ...
  Lines.append(new Line(-50,-30,-30,-30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // B0
  Lines.append(new Line(-50,-10,-30,-10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // B1
  Lines.append(new Line(-50, 10,-30, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // B2
  Lines.append(new Line(-50, 30,-30, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // B3

  Lines.append(new Line( 30, 30, 50, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // G3
  Lines.append(new Line( 30, 10, 50, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // G2
  Lines.append(new Line( 30,-10, 50,-10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // G1
  Lines.append(new Line( 30,-30, 50,-30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // G0
