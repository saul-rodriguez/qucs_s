...
{
  Lines.append(new Line(-40, -50, 40,-50,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 40, -50, 40, 60,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 40,  60,-40, 60,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-40,  60,-40, -50,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
