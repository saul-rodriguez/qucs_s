...
Gyrator::Gyrator()
{
  ...
  Arcs.append(new Arc(  3, -9, 18, 18, 16*90, 16*180,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Arcs.append(new Arc(-21, -9, 18, 18,16*270, 16*180,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line(-30,-30,-12,-30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-30, 30,-12, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 12,-30, 30,-30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 12, 30, 30, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line( 12,-30, 12, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-12,-30,-12, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
