...
void SpiceFile::createSymbol()
{
  ...
  #define HALFWIDTH  17
  int h = 30*((No-1)/2) + 15;
  Lines.append(new Line(-HALFWIDTH, -h, HALFWIDTH, -h,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( HALFWIDTH, -h, HALFWIDTH,  h,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-HALFWIDTH,  h, HALFWIDTH,  h,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-HALFWIDTH, -h,-HALFWIDTH,  h,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  ...
  while(i<No) { // add ports lines and numbers
    Lines.append(new Line(-30,  y,-HALFWIDTH,  y,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    ...
    Lines.append(new Line(HALFWIDTH,  y, 30,  y,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    Ports.append(new Port( 30,  y));
    tmp = PortNames.section(',', i, i).mid(4);
  ...
  if(No > 0) {
    Lines.append(new Line( 0, h, 0,h+15,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
