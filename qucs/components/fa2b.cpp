...
{
  Lines.append(new Line(-40, -60, 40,-60,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 40, -60, 40, 90,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 40,  90,-40, 90,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-40,  90,-40, -60,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line(-60,-10,-40,-10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // X0
  Lines.append(new Line(-60, 10,-40, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // X1
  ...
  Lines.append(new Line(-60, 70,-40, 70,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // CI

  Lines.append(new Line( 40, 30, 60, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // C0
  Lines.append(new Line( 40, 10, 60, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // S1
  Lines.append(new Line( 40,-10, 60,-10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // S0

  Lines.append(new Line( -10, -55, 10, -55, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  
  Lines.append(new Line( -10, -55,  0, -45, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  
  Lines.append(new Line(  0,  -45,-10, -35, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  
