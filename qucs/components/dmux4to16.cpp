...
void dmux4to16::createSymbol()
{
  ...
  Lines.append(new Line( 30, -90, 30, 110,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 30,  110,-30, 110,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-30,  110,-30, -90,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  ...
  Lines.append(new Line(-50, 10,-30, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // C
  Lines.append(new Line(-50, 30,-30, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // D

  Lines.append(new Line( 30, 100, 50,100,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y15
  Lines.append(new Line( 30,  90, 50, 90,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y14
  Lines.append(new Line( 30,  80, 50, 80,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y13
  Lines.append(new Line( 30,  70, 50, 70,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y12
  Lines.append(new Line( 30,  60, 50, 60,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y11
  Lines.append(new Line( 30,  50, 50, 50,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y10
  Lines.append(new Line( 30,  40, 50, 40,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y9
  Lines.append(new Line( 30,  30, 50, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y8
  Lines.append(new Line( 30,  20, 50, 20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y7
  Lines.append(new Line( 30,  10, 50, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y6
  Lines.append(new Line( 30,   0, 50,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y5
  Lines.append(new Line( 30, -10, 50,-10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y4
  Lines.append(new Line( 30, -20, 50,-20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y3
  Lines.append(new Line( 30, -30, 50,-30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y2
  Lines.append(new Line( 30, -40, 50,-40,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));  // Y1
  ...
  Lines.append(new Line(-6,  2, 9,  2, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
