...
Thyristor::Thyristor()
{
  ...
  Lines.append(new Line(  0,-30,  0, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -9,  6,  9,  6,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( -9, -6,  9, -6,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0,  6, -9, -6,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0,  6,  9, -6,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line( -9, 10, -5,  6,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-20, 10, -9, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
