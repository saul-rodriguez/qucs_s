...
void MOSFET::createSymbol()
{
  ...
  Lines.append(new Line(-10, 11,  0, 11,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0,  0,  0, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-10,  0,  0,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  ...
  if(Props.first()->Value == "nfet") {
    ...
    Lines.append(new Line( -1,  0, -6, -5,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    Lines.append(new Line( -1,  0, -6,  5,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  }

  if((Props.next()->Value.trimmed().at(0) == '-') ==
     (Props.first()->Value == "nfet"))
    Lines.append(new Line(-10, -8,-10,  8,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  else
    Lines.append(new Line(-10, -4,-10,  4,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
