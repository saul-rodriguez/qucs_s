...
{  
  ...
  Lines.append(new Line(-15, -h, 15, -h,QPen(gCustomPref.componentColor,gCustomPref.componentThickness))); // top side
  Lines.append(new Line( 15, -h, 15,  h,QPen(gCustomPref.componentColor,gCustomPref.componentThickness))); // right side
  Lines.append(new Line(-15,  h, 15,  h,QPen(gCustomPref.componentColor,gCustomPref.componentThickness))); // bottom side
  Lines.append(new Line(-15, -h,-15,  h,QPen(gCustomPref.componentColor,gCustomPref.componentThickness))); // left side
  ...
  while(i<Num) { // for every branch
    ...
    Lines.append(new Line(-30, y,-15, y,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    ...
    if (i > 1) {
      ...
      Lines.append(new Line(-15, yh, 15, yh, QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    }
    // right connection with port
    Lines.append(new Line( 15, y, 30, y,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    Ports.append(new Port( 30, y));
