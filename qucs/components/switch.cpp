...
void Switch::createSymbol()
{
  if(Props.getFirst()->Value != "on") {
    Lines.append(new Line(-15,  0, 15,-15,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    y1 = -17;
  }
  else {
    Lines.append(new Line(-15,  0, 16,-5,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
    y1 = -7;
  }

  Lines.append(new Line(-30,  0,-15,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 17,  0, 30,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Arcs.append(new Arc( 12, -3, 5, 5, 0, 16*360,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Ellips.append(new Area(-18, -3, 6, 6, QPen(gCustomPref.componentColor,gCustomPref.componentThickness),
