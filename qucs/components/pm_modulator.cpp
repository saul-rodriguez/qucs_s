...
PM_Modulator::PM_Modulator()
{
  ...
  Arcs.append(new Arc( -7, -4,  7,  7,     0, 16*180,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Arcs.append(new Arc(  0, -4,  7,  7,16*180, 16*180,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0, 30,  0, 12,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0,-30,  0,-12,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  ...
  Lines.append(new Line(-12,  0,-17,  5,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-12,  0,-17, -5,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
