...
symTrafo::symTrafo()
{
  ...
  Arcs.append(new Arc(-21,-64,  5,  5,  0, 16*360,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Arcs.append(new Arc(-21, 15,  5,  5,  0, 16*360,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Arcs.append(new Arc( 15,-24,  5,  5,  0, 16*360,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
