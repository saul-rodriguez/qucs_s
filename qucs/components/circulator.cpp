...
Circulator::Circulator()
{
  ...
  Arcs.append(new Arc(-14,-14, 28, 28,  0,16*360,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-30,  0,-14,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 30,  0, 14,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  0, 14,  0, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Arcs.append(new Arc( -8, -6, 16, 16,16*20,16*150,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  8,  0,  9, -7,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(  8,  0,  2, -1,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line(-22, -4,-26,  4,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));   // marks port 1
