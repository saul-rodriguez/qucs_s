...
Amplifier::Amplifier()
{
  ...
  Lines.append(new Line(-16,-20,-16, 20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-16,-20, 16,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-16, 20, 16,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));

  Lines.append(new Line(-30,  0,-16,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 16,  0, 30,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
