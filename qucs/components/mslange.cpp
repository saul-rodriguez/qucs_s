...
MSlange::MSlange()
{
  ...
  Lines.append(new Line(-30,-30,-30, 10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line(-30, 30,-30, 20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  ...
  Lines.append(new Line(-25,  0, 25,  0,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));      
  Lines.append(new Line(-30,-10, 30,-10,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));    
  Lines.append(new Line(  0,-20, 30,-20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));    
  Lines.append(new Line( 30,-30, 30,-20,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));
  Lines.append(new Line( 30,-10, 30, 30,QPen(gCustomPref.componentColor,gCustomPref.componentThickness)));          
